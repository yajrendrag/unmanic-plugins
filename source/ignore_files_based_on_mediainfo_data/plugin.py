...
logger = logging.getLogger("Unmanic.Plugin.ignore_files_based_on_mediainfo_data")
...
def file_ends_in_disallowed_values(media_info, stream_field, disallowed_values):
    """
    ...
    try:
        ...
        discovered_values = expr.evaluate(file_probe_streams)

    except KeyError as e:
        logger.debug("Failed to match the JSONata query keys to in the mediainfo data of the file '%s'.", file_path)

    except ValueError as e:
        logger.debug("Failed to match the JSONata query value to in the mediainfo data of the file '%s'.", file_path)
...
def on_library_management_file_test(data):
    ...
    in_disallowed_values = file_ends_in_disallowed_values(media_info, stream_field, disallowed_values)
