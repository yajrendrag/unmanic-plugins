...
from video_trim2.lib.ffmpeg import StreamMapper, Probe, Parser

# Configure plugin logger
logger = logging.getLogger("Unmanic.Plugin.video_trim2")
...
class PluginStreamMapper(StreamMapper):
    ...
    def __gen_start_args(self, duration):
        ...
        if start_seconds and float(start_seconds) > 0:
            ...
            self.set_ffmpeg_generic_options(**generic_options)
